...
import { hashPassword, toAuthResult } from '../shared';
...
export class AuthRegisterService extends AuthBaseService {
  ...
  async register(dto: RegisterDto): Promise<AuthResultDto> {
    // Bir xil email bilan aktiv user bor-yo'qligini tekshiramiz.
    ...
    // User saqlangach to'g'ridan-to'g'ri auth tokenlarini qaytaramiz.
